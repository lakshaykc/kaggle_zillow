...
#train2016['structuretaxvaluedollarcnt'] = np.nan
#train2016['landtaxvaluedollarcnt'] = np.nan
...
submission.to_csv('Only_CatBoost_17_12.csv', float_format='%.6f',index=False)
